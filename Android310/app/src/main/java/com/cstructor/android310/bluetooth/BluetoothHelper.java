...
public class BluetoothHelper {
    ...
    private static final UUID SPP_UUID = UUID.fromString("2B55487A-5619-4A25-B255-EB1F629A028B");
     ...
     */
    public BluetoothHelper(Context context, BluetoothHelperHandler handler) {
        mContext = context;
    ...
    private synchronized void setState(State state) {
        ...
        mHandler.obtainMessage(BluetoothHelperHandler.MessageType.STATE, -1, state).sendToTarget();
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(BluetoothHelperHandler.MessageType.READ, bytes, buffer)
                            .sendToTarget();
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BluetoothHelperHandler.MessageType.WRITE, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
