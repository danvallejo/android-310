...
import com.cstructor.android310.models.Message;
...
public class FirebaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        messageListAdapter = new MessageListAdapter(this, Message.class, R.layout.message_chat, uwChatReference);
